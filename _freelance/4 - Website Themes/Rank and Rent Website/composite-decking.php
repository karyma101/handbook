...
in your form:</strong>'.$error.'</div>';
  ...
  if (mail("info@yourdomainname.com", "Message from Composite Decking Page", 
...
<html lang="en">
  <head>
   ...
   <title>Composite Decking</title> <!-- Your Page Title -->
...
<div class="display-banner">
  ...
  <h1 align="center">COMPOSITE DECKING</h1>
...
<div class="container">
  ...
  <div class="row composite-decking">
...
<p align="center"><img src="images/composite-decks.jpg" class="img-responsive" alt="composite-decking-sa"></p>
<br /><br />
...
<footer>
    ...
    <div align="center" id="footer">
      ...
      <a href="https://yourwebsitename.com/hardwood-decking.php">HARDWOOD DECKING</a> 
