...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Social media for dentist practices."/>
   
    <title>Social Media for Dentist Practices</title>
...
<!-- End of Modal -->
                 ...
                 <br>
                  ...
                  <div class="center-block" align="center">
                            ...
                            <a href="https://youragencydomain.com"><p class="logo-image" align="center">&nbsp;</p></a>
                              ...
                              <p class="tagline" align="center">Social Media for Dentist Practices</p>
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation" id="topnavbar">
   ...
   <?php echo $result; ?>
  	...
  	<p class="wd-heading-question" align="center">Social Media for Dentist Practices</p>  
	...
	<br>
	 ...
	 <div class="container-fluid" align="center">
	  ...
	  <div style="max-width: 740px">
		  ...
		  <p class="text-padding">Social Media portrays credibility and it's an effective tool to inform existing patients of relevant news as well as to acquire new patients.</p>
		  
		  <br><br>
		  
		  <p align="center">The main social media platforms for Dentists are:</p>
		  
			<br><br>
	  	
	  	<p><img class="img-responsive" src="images/social-media-for-dentists.jpg" alt="social-media-management-dentists" /></p>
  		...
  		<p>The truth is that one of the first things potential patients do is to find out what other patients think of your Dentistry Practice.</p>
  		...
  		<p><img class="img-responsive" src="images/social-media-explained.jpg" alt="social-media-explained-dentists" /></p>
  		
  		<br>
  		
  		<p>We create, optimize and manage your Dentist Practice social media profiles to create more credibility so that your practice gets more patients.</p>
