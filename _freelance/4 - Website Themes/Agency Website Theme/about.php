...
<html lang="en">
  <head>
    ...
    <title>Dentist Marketing: About Us</title>
...
<!-- End of Modal -->
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation" id="topnavbar">
   ...
   <?php echo $result; ?>
  	...
  	<p class="heading-question" align="center">About Us</p>  
	...
	<br><br><br>
	 ...
	 <div class="container-fluid" align="center">
	  ...
	  <div style="max-width: 600px">
		  ...
		  <p><strong><em>Dentist Marketing</em></strong> is a digital marketing agency dedicated to growing Dentist Practices. We are focused on results and we are as passionate as you are about growing your practice.</p>
	  	
	  	<br>
	  	
	  	<p>Our team has over 20 years worth of combined experience helping companies grow online.</p>
	  	
	  	<br>
	  	
	  	<p>We now only work with Dentist Practices by improving their online presence and to get new patients.</p>

	<br>
	<br>
	
	<p>If you have any further questions, please don't hesitate in <a href="https://youragencydomain.com/contact.php">contacting us</a>.</p>
